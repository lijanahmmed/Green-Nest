    ...
    <div className="mt-15 w-11/12 md:w-10/12 mx-auto">
      ...
      <div className="card-body">
        <fieldset className="fieldset">
          ...
          <textarea className="w-80 h-32 border border-gray-300 p-3" name="" id="" placeholder="Write your message"></textarea>
          <button className="btn bg-green-600 text-white mt-4">Message</button>
        </fieldset>
      </div>
    </div>
    </div>
