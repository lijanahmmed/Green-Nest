    ...
    <div className="mt-15 w-11/12 md:w-10/12 mx-auto">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-500">
          Learn from our experienced plant experts dedicated to helping your greens grow healthier and happier.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10 p-3">
        <div className="card bg-base-100 shadow-sm p-3 hover:scale-105">
          ...
          <div className="space-y-3 mt-3">
            ...
            <p className="text-gray-500">Expert in succulents, drought-tolerant plants, and minimalist plant setups that thrive with minimal watering and maintenance.</p>
          </div>
        </div>
        <div className="card bg-base-100 shadow-sm p-3 hover:scale-105">
          <figure>
          ...
          <div className="space-y-3 mt-3">
            ...
            <p className="text-gray-500">Specialized in nurturing indoor plants, improving air quality, and creating sustainable green spaces with easy-care houseplants.</p>
          </div>
        </div>
        <div className="card bg-base-100 shadow-sm p-3 hover:scale-105">
          <figure>
          ...
          <div className="space-y-3 mt-3">
            ...
            <p className="text-gray-500">Specializes in tropical, decorative houseplants and interior plant styling, bringing natural beauty and freshness to modern homes.</p>
          </div>
        </div>
      </div>
    </div>
